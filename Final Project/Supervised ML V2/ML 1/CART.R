...
unsupervised_significant_df_PHQ9_no_loc_emp <- uncorrelated_unsupervised_significant_df_PHQ9_2 %>%
...
plot(roc_CART, main = "CART ROC Curve", auc.polygon = TRUE, grid = TRUE, 
